!function () {
    ...
    function p(t) {
        ...
        t.wpcf7 = {
            ...
            const r = (t, r) => {
                const n = e(t.getAttribute("data-starting-value")), a = e(t.getAttribute("data-maximum-value")),
                ...
                e = {init: !1, ...e}, t.querySelectorAll(".wpcf7-character-count").forEach((n => {
                    const a = n.getAttribute("data-target-name"), c = t.querySelector(`[name="${a}"]`);
    ...
    document.addEventListener("DOMContentLoaded", (e => {
        ...
        "function" == typeof r.forEach ? (wpcf7 = {
            init: p,
            submit: c,
            reset: o, ...null !== (t = wpcf7) && void 0 !== t ? t : {}
